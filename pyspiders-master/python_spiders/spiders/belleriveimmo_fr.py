...
class MySpider(Spider):
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : [
                    "https://www.belleriveimmo.fr/annonces-location/appartement/",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "https://www.belleriveimmo.fr/annonces-location/maison/",
                ],
                "property_type" : "house",
            },
        ]
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Belleriveimmo_PySpider_france", input_type="VALUE")
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_name", input_value="Bellerive Immo", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_phone", input_value="04 70 41 08 01", input_type="VALUE")
