...
class MySpider(Spider):
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-lh-corbeil.com/annonces/location/v-corbeil+essonnes/?types_biens=appartement&xhr=true", "property_type": "apartment"},
	        {"url": "https://www.century21-lh-corbeil.com/annonces/location/v-corbeil+essonnes/?types_biens=maison&xhr=true", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21hcorbeil_PySpider_"+ self.country + "_" + self.locale)
        ...
        item_loader.add_value("landlord_phone", "01 60 89 20 20")
        item_loader.add_value("landlord_name", "CENTURY 21 Lesueur et Horlin")
