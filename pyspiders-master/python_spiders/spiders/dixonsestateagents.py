...
class DixonsestateagentsSpider(scrapy.Spider):
    name = "dixonsestateagents"
    allowed_domains = ["www.dixonsestateagents.co.uk"]
    start_urls = (
        'http://www.www.dixonsestateagents.co.uk/',
    )
    ...
    thousand_separator=','
    scale_separator='.'
    external_source="Dixonsestateagents_PySpider_united_kingdom_en"
    custom_settings = {
    ...
    def start_requests(self):
        start_urls = [
            {
                "url": [
                    "https://www.dixonsestateagents.co.uk/search.ljson?channel=lettings&fragment=tag-flat/most-recent-first/status-all/page-1",
                ],
                "property_type": "apartment"
            },
	        {
                "url": [
                    "https://www.dixonsestateagents.co.uk/search.ljson?channel=lettings&fragment=tag-house/most-recent-first/status-all/page-1"
                ],
                "property_type": "house"
            },
        ]  # LEVEL 1
