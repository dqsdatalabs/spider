...
class MySpider(Spider):
    name = 'maizieresles_metz_guy_hoquet_com'
    execution_type='testing'
    country='france'
    locale='fr'
    # DYNAMIC VALUES
    source_name = "Maizieresles_metz_guy_hoquet_PySpider_france_fr"
    landlord_n = "GUY HOQUET MAIZIERES-LES-METZ"
    landlord_p = "03 87 51 90 59"
    # --------------
    ...
    headers = {
        ...
        'referer': "https://maizieres-les-metz.guy-hoquet.com/biens/result",
    ...
    def start_requests(self):
        start_urls = [
            ...
            {"url": "https://maizieres-les-metz.guy-hoquet.com/biens/result?1&templates%5B%5D=properties&p=1&t=&filters%5B10%5D%5B%5D=2&filters%5B30%5D%5B0%5D%5B%5D=appartement&with_markers=false&_=1603889215308", "property_type": "apartment"},
	        {"url": "https://maizieres-les-metz.guy-hoquet.com/biens/result?1&templates%5B%5D=properties&p=1&t=&filters%5B10%5D%5B%5D=2&filters%5B30%5D%5B0%5D%5B%5D=maison&with_markers=false&_=1603889215310", "property_type": "house"},
        ] 
    ...
    def populate_item(self, response):
        ...
        city_zip = response.xpath("//div[@class='add']/text()").get()
        if city_zip:
            city = " ".join(city_zip.strip().split(" ")[:-1])
            zipcode = city_zip.strip().split(" ")[-1]
