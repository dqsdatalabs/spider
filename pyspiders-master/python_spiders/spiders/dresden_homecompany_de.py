...
class Dresden_homecompany_deSpider(Spider):
    name = 'dresden_homecompany_de'
    country='germany'
    locale='de' 
    external_source = "{}_PySpider_{}_{}".format(name.capitalize(), country, locale)
    execution_type='testing'
    allowed_domains = ["www.dresden.homecompany.de"]
    start_urls = ["https://dresden.homecompany.de/en/suchergebnis/noreset/1"]
    position = 1
    ...
    def populate_item(self, response):
        ...
        landlord_phone = "+ 49 (0) 351 - 2072662"
        landlord_email = "dresden@homecompany.de"
