...
class Essen_homecompany_deSpider(Spider):
    name = 'essen_homecompany_de'
    country='germany'
    locale='de' 
    external_source = "{}_PySpider_{}_{}".format(name.capitalize(), country, locale)
    execution_type='testing'
    allowed_domains = ["www.essen.homecompany.de"]
    start_urls = ["https://essen.homecompany.de/en/suchergebnis/noreset/1"]
    position = 1
    ...
    def populate_item(self, response):
        ...
        price_title = response.css('span.pricetitle::text').get()
        if( price_title != "Rent"):
            return
        ...
        landlord_phone = "+ 49 (0) 201 - 19 44 5"
        landlord_email = "essen@homecompany.de"
