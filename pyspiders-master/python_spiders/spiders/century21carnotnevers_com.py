...
class MySpider(Spider):
    name = 'century21carnotnevers_com'
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-carnot-nevers.com/annonces/location/?types_biens=appartement&xhr=true", "property_type": "apartment"},
	        {"url": "https://www.century21-carnot-nevers.com/annonces/location/?types_biens=maison&xhr=true", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21carnotnevers_PySpider_"+ self.country + "_" + self.locale)
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 Carnot")
        item_loader.add_value("landlord_phone", "03 86 57 93 76")
        item_loader.add_value("landlord_email", "carnot.immobilier@century21.fr")
