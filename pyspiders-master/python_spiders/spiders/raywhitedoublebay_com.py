...
class MySpider(Spider):
    name = 'raywhitedoublebay_com'
    execution_type='testing'
    country='australia'
    locale='en'
    external_source = "Raywhitedoublebay_PySpider_australia"
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : [
                    "https://raywhitedoublebay.com/properties/residential-for-rent?category=APT%7CUNT&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "https://raywhitedoublebay.com/properties/residential-for-rent?category=HSE%7CTCE%7CTHS&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
                "property_type" : "house"
            },
            {
                "url" : [
                    "https://raywhitedoublebay.com/properties/residential-for-rent?category=STD&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="rent", input_value="//span[contains(@class,'pdp_price')]/text()[not(contains(.,'Price'))]", input_type="F_XPATH", get_num=True, per_week=True,split_list={" ":0, ".":0}, replace_list={"$":"", ",":""})
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_name", input_value="Ray White Double Bay", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_phone", input_value="61 (2) 9363 9999", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_email", input_value="info.doublebay@raywhite.com", input_type="VALUE")
