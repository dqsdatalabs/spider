...
class MySpider(Spider):
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : [
                    "https://www.rightmove.co.uk/property-to-rent/find.html?locationIdentifier=BRANCH%5E121078&propertyTypes=flat&primaryDisplayPropertyType=flats&includeLetAgreed=true&mustHave=&dontShow=&furnishTypes=&keywords=",
                ],
                "property_type" : "apartment"
            },
            {
                "url" : [
                    "https://www.rightmove.co.uk/property-to-rent/find.html?locationIdentifier=BRANCH%5E121078&propertyTypes=bungalow%2Cdetached%2Csemi-detached%2Cterraced&includeLetAgreed=true&mustHave=&dontShow=&furnishTypes=&keywords=",
                ],
                "property_type" : "house"
            },   
        ]
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Urbansleeplettings_PySpider_"+ self.country + "_" + self.locale)
        ...
        item_loader.add_value("landlord_name", "Urban Sleep, Liverpool")
        item_loader.add_value("landlord_phone", "0151 954 0477")
