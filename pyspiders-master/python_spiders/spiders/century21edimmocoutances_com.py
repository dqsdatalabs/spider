...
class MySpider(Spider): 
    name = 'century21edimmocoutances_com'
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-edimmo-coutances.com/annonces/location/?types_biens=appartement&xhr=true", "property_type": "apartment"},
	        {"url": "https://www.century21-edimmo-coutances.com/annonces/location/?types_biens=maison&xhr=true", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21edimmocoutances_PySpider_"+ self.country + "_" + self.locale)
        ...
        images =[response.urljoin(x) for x in response.xpath("//img[@title='Afficher la photo en grand']/@data-src").getall()]
        if images:
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 Ed'Immo")
        item_loader.add_value("landlord_phone", "02 33 46 28 55")
        item_loader.add_value("landlord_email", "edimmo@century21.fr")
