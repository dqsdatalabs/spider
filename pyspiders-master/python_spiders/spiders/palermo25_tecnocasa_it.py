...
class Palermo25_tecnocasaSpider(scrapy.Spider):
        
    name = 'palermo25_tecnocasa'
    execution_type = 'testing'
    country = 'italy'
    locale = 'it'
    external_source = f"{name.capitalize()}_PySpider_{country}_{locale}"
    allowed_domains = ['www.palermo25.tecnocasa.it/']
    start_urls = ['https://palermo25.tecnocasa.it/appartamenti-in-affitto']
    ...
    def parse(self, response):
        ...
        for index, card in enumerate(cards):
            ...
            Palermo25_tecnocasaSpider.position += 1
    ...
    def parseApartment(self, response):
        ...
        landlord_email = "pacso@tecnocasa.it"
        landlord_phone = "0918420830"
        landlord_name = "Gruppo Tecnocasa"
