...
class MySpider(Spider):
    name = 'era_arcadimmo_com'
    execution_type='testing'
    country='france'
    locale='fr'
    b_url = "http://www.era-arcadimmo.com"
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Era_Arcadimmo_PySpider_france")
        ...
        if rent:
            rent = rent.split("Loyer")[1].split("€")[0].strip().replace("\u00a0","")
        ...
        if landlord_name:
            ...
            item_loader.add_value("landlord_name", "ERA ARCAD'IMMO")
        ...
        if landlord_phone:
            ...
            item_loader.add_value("landlord_phone", "05 61 54 80 30")
