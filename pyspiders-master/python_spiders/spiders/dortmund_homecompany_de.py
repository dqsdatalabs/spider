...
class Dortmund_homecompany_deSpider(Spider):
    name = 'dortmund_homecompany_de'
    country='germany'
    locale='de' 
    external_source = "{}_PySpider_{}_{}".format(name.capitalize(), country, locale)
    execution_type='testing'
    allowed_domains = ["www.dortmund.homecompany.de"]
    start_urls = ["https://dortmund.homecompany.de/en/suchergebnis/noreset/1"]
    position = 1
    ...
    def populate_item(self, response):
        ...
        landlord_phone = " + 49 (0) 231 - 19445"
        landlord_email = "dortmund@homecompany.de"
