...
class MySpider(Spider):
    name = 'kwturkiye_com_kwplatin'
    execution_type='testing'
    country='turkey'
    locale='tr'
    external_source="Kwturkiyeplatin_PySpider_turkey_tr"
    ...
    def parse(self, response):
        ...
        for item in data["result"]["items"]:
            ext_url = "https://www.kwturkiye.com/" + item["seoFriendlyURL_ENU"]
        ...
        if page == 24 or seen:
            payload = "{\"skipCount\":" + str(page) + ",\"maxResultCount\":24,\"transactionType\":\"2\",\"listingClass\":\"1\",\"macroProvinceId\":null,\"provinceId\":null,\"cityId\":null,\"localZoneIds\":[],\"currency\":\"TRY\",\"maxPrice\":null,\"minPrice\":null,\"propertyType\":" + response.meta.get("property_code") + ",\"bedRoomCount\":null,\"bathRoomCount\":null,\"squareMeter\":null,\"parkingSpace\":null,\"totalRoomCount\":null,\"totalAreaSqMeter\":null,\"lotSizeSqMeter\":null,\"developmentId\":null,\"buildingId\":null,\"energyLevel\":null,\"addedDay\":0,\"agentId\":0,\"officeId\":\"1006\",\"teamId\":0,\"officeName\":\"KW Bornova\",\"agentName\":\"\",\"upComingOpenHouse\":null,\"orderByCriteria\":1026,\"id\":null,\"tenantId\":1,\"regionId\":2004,\"districtIds\":[],\"measurementType\":1,\"freeTextSearch\":\"\",\"homeRegionCurrencyUID\":146,\"homeRegionId\":2004,\"isLuxury\":false,\"station\":null,\"isVirtualOpenHouse\":false,\"taxIncluded\":false}"
            yield Request(
                "https://www.kwturkiye.com/api/services/app/listings/GetListingsForWebSite",
                method="POST",
                body=payload,
    ...
    def populate_item(self, response):
        ...
        ext_url = "https://www.kwturkiye.com/"+external_id
        item_loader.add_value("external_link", ext_url)
            
        script = data['result']['listing']['listingDescription'][0]['description']
        if script:
            sel = Selector(text=script, type='html')
            item_loader.add_value("description", "".join(sel.xpath("//text()").getall()))

        bathroom = data['result']['listing']["bathRooms"]
        if bathroom:
            bath = int(float(bathroom))
        ...
        if parking:
            ...
            parking = data['result']['listing']["parkingSpaces"]
            if parking != 0:
