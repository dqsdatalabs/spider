...
class MySpider(Spider):
    ...
    country = 'netherlands'
    locale = 'nl' 
    external_source = 'Makas_PySpider_netherlands'
    start_urls = ['https://www.makas.nl/nl/realtime-listings/consumer'] 
    # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("landlord_name", "Makelaarsassociatie B.V.")
        item_loader.add_value("landlord_phone", "[070] 352 68 00")
        item_loader.add_value("landlord_email", "rentals@makas.nl")
