...
class MySpider(Spider):
    ...
    def start_requests(self):
        ...
        formdata = {
            "action": "all_houses",
            "api": "02cfce5d44cae407b168383e15f1ba00",
            "filter": "status=rent&house_type=Room",
            "offsetRow": "0",
            "numberRows": "10000",
            "leased_wr_last": "true",
            "leased_last": "true",
            "sold_wr_last": "true",
            "sold_last": "true",
            "path": "/woningaanbod?status=rent&house_type=Room",
            "lang": "aanbod",
            "html_lang": "en",
        }
        yield FormRequest(
        ...
        formdata = {
            "action": "all_houses",
            "api": "02cfce5d44cae407b168383e15f1ba00",
            "filter": "status=rent&house_type=Studio",
            "offsetRow": "0",
            "numberRows": "10000",
            "leased_wr_last": "true",
            "leased_last": "true",
            "sold_wr_last": "true",
            "sold_last": "true",
            "path": "/woningaanbod?status=rent&house_type=Studio",
            "lang": "aanbod",
            "html_lang": "en",
        }
        yield FormRequest(
        ...
        try:
            for item in data:
                ...
                if status and "verhuurd" in status.lower():
                    continue
                follow_url = f"https://www.maxsuites.nl/woning?{item['city']}/{item['street']}/{item['house_id']}".replace(" ", "-")
    ...
    def get_property_info(self, response):
        ...
        item_loader.add_value("external_source", "Maxsuites_PySpider_netherlands")
        ...
        if desc:
            ...
            if "Servicekosten:" in desc:
                utilities = desc.split("Servicekosten:")[1].split(",")[0].replace("€","").strip()
        ...
        item_loader.add_value("landlord_name", "Max Suites")
        item_loader.add_value("landlord_phone", "+31107640518")
        item_loader.add_value("landlord_email", "shortstay@maxrentals.nl")
