...
class Freiburg_homecompany_deSpider(Spider):
    name = 'duesseldorf_homecompany_de'
    country='germany'
    locale='de' 
    external_source = "{}_PySpider_{}_{}".format(name.capitalize(), country, locale)
    execution_type='testing'
    allowed_domains = ["www.duesseldorf.homecompany.de"]
    start_urls = ["https://duesseldorf.homecompany.de/en/suchergebnis/noreset/1"]
    position = 1
    ...
    def populate_item(self, response):
        ...
        landlord_phone = "+ 49 (0) 211 - 4497301"
        landlord_email = "duesseldorf@homecompany.de"
