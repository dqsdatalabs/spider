...
class Berlin_homecompany_deSpider(Spider):
    name = 'berlin_homecompany_de'
    country='germany'
    locale='de' 
    external_source = "{}_PySpider_{}_{}".format(name.capitalize(), country, locale)
    execution_type='testing'
    allowed_domains = ["www.berlin.homecompany.de"]
    start_urls = ["https://berlin.homecompany.de/en/suchergebnis/noreset/1"]
    position = 1
    ...
    def populate_item(self, response):
        ...
        landlord_phone = "+ 49 (0) 30 - 19445"
        landlord_email = "berlin@homecompany.de"
