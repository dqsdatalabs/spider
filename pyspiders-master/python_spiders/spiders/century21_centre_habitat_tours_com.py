...
class MySpider(Spider):
    name = 'century21_centre_habitat_tours_com'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source =  "Century21_Centre_Habitat_Tours_PySpider_france"
    # custom_settings = {
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-centre-habitat-tours.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-centre-habitat-tours.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("landlord_name", "Century 21 Centre Habitat")
