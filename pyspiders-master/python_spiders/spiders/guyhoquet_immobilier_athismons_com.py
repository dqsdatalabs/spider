...
class MySpider(Spider):
    name = 'guyhoquet_immobilier_athismons_com'
    execution_type='testing'
    country='france'
    locale='fr'
    gh_domain = "https://athis-mons.guy-hoquet.com"
    headers = {
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Guyhoquet_Immobilier_Athismons_PySpider_france")
