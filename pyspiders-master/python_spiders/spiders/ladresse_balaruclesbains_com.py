...
class MySpider(Spider):
    name = 'ladresse_balaruclesbains_com'
    execution_type='testing'
    country='france'
    locale='fr'
    # DYNAMIC DATA
    b_url = "https://www.ladresse-balaruclesbains.com"
    source_name = "Ladresse_Balaruclesbains_PySpider_france"
    landlord_n = "l'Adresse - BALARUC LES BAINS"
    landlord_p = "04.67.53.77.14"
    # ------------
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="room_count", input_value="//ul/li/span[@class='critere-value']/text()[contains(.,'chambre')]", input_type="F_XPATH", get_num=True)
