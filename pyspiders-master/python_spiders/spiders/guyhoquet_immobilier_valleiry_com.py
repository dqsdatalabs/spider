...
class MySpider(Spider):
    name = 'guyhoquet_immobilier_valleiry_com'
    execution_type='testing'
    country='france'
    locale='fr'
    
    gh_domain = "https://valleiry.guy-hoquet.com"
    headers = {
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Guyhoquet_Immobilier_Valleiry_PySpider_france")
        ...
        item_loader.add_value("landlord_email", "valleiry@guyhoquet.com")
