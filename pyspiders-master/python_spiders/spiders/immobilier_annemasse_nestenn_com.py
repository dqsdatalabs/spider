...
class MySpider(Spider):
    name = 'immobilier_annemasse_nestenn_com'
    execution_type='testing'
    country='france'
    locale='fr'
    # DYNAMIC DATA
    b_url = "https://immobilier-annemasse.nestenn.com"
    external_source = "Immobilier_Annemasse_Nestenn_PySpider_france"
    landlord_n = "Agent immobilier Annemasse"
    landlord_p = "04 50 37 20 43"
    # -------------
    ...
    def parse(self, response):
        ...
        for item in response.xpath("//div[@id='bienParent1']/div[@id='annonce_entete_right']//div[@class='lazyload']/script/text()").extract():
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="bathroom_count", input_value="//div[@id='groupeIcon']/div/div[contains(.,'salle')]/text()", input_type="F_XPATH", get_num=True, split_list={" ":0})
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_email", input_value="annemasse@nestenn.com", input_type="VALUE")
