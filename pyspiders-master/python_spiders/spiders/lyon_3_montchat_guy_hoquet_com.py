...
class MySpider(Spider):
    name = 'lyon_3_montchat_guy_hoquet_com'
    execution_type='testing'
    country='france'
    locale='fr'
    # DYNAMIC VALUES
    gh_domain = "https://lyon-3-montchat.guy-hoquet.com"
    source_name = "Lyon_3_Montchat_Guy_Hoquet_PySpider_france"
    landlord_n = "GUY HOQUET LYON 3 MONTCHAT"
    landlord_p = "04 37 56 78 07"
    # --------------
    headers = {
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="room_count", input_value="//div[@id='intro']//i[contains(@class,'ico king')]/following-sibling::div/text()", input_type="F_XPATH", get_num=True, split_list={" ":0})
