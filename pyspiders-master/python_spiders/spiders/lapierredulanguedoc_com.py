...
class MySpider(Spider):
    name = 'lapierredulanguedoc_com'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source="Lapierredulanguedoc_PySpider_france"
    custom_settings = {
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : [
                    "https://www.lapierredulanguedoc.com/a-louer/1",
                ],
            },
        ]
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("landlord_name","Lapierre du languedoc")
        item_loader.add_value("landlord_phone","04 68 76 14 77")
        item_loader.add_value("landlord_email","agence.lapierredulanguedoc@orange.fr")
