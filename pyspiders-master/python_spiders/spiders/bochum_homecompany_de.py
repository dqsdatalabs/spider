...
class Bochum_homecompany_deSpider(Spider):
    name = 'bochum_homecompany_de'
    country='germany'
    locale='de' 
    external_source = "{}_PySpider_{}_{}".format(name.capitalize(), country, locale)
    execution_type='testing'
    allowed_domains = ["www.bochum.homecompany.de"]
    start_urls = ["https://bochum.homecompany.de/en/suchergebnis/noreset/1"]
    position = 1
    ...
    def populate_item(self, response):
        ...
        landlord_email = "bochum@homecompany.de"
