...
class MySpider(Spider):
    name = 'abaquegestion_fr'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source="Abaquegestion_PySpider_france"
    custom_settings = {
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : [
                    "https://www.abaquegestion.fr/a-louer/1",
                ],
            },
        ]
    ...
    def parse(self, response):
        for item in response.xpath("//div[@class='col-xs-12 col-sm-5 panel-heading']/@onclick").getall():
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("landlord_name","Abaque Gestion")
        item_loader.add_xpath("landlord_phone","//span[@class='icon-telephone icons fs-35']/following-sibling::span/text()")
        item_loader.add_value("landlord_email","contact@abaquegestion.fr")
