...
class SoldbyroseSpider(scrapy.Spider):
    ...
    def parseApartment(self, response):
        ...
        external_link = f"https://www.soldbyrose.ca{jsonResponse['seoURL']}"
        ...
        landlord_phone = "4167397200"
        landlord_email = "info@soldbyrose.ca"
        landlord_name = "Sutton Group-Admiral Realty Inc., Brokerage - (Jeanne Rose Printz)"
