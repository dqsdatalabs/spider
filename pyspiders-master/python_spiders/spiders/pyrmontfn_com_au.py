...
class MySpider(Spider):
    name = 'pyrmontfn_com_au'
    execution_type='testing'
    country='australia'
    locale='en'
    headers = {
        "accept": "*/*",
        'referer': 'https://pyrmontfn.com.au/lease',
    ...
    def start_requests(self):
        start_urls = [
            {
                "url": [
                    "https://pyrmontfn.com.au/json/data/listings/?authenticityToken=6OzvjunY3x9xCywPIhL2Cw%3D%3D&_method=post&input_types=&office_id=&listing_category=&staff_id=&postcode=&rental_features=&listing_sale_method=Lease&rental_features=&status=&listing_suburb_search_string=&listing_suburb_id=&surrounding_radius=6&listing_property_type=Apartment&LISTING_BEDROOMS=&LISTING_BATHROOMS=&CARPORTS=&LISTING_PRICE_FROM=&LISTING_PRICE_TO=&sort=date-desc&gallery&limit=12",
                ],
                "property_type": "apartment"
            },
	        {
                "url": [
                    "https://pyrmontfn.com.au/json/data/listings/?authenticityToken=6OzvjunY3x9xCywPIhL2Cw%3D%3D&_method=post&input_types=&office_id=&listing_category=&staff_id=&postcode=&rental_features=&listing_sale_method=Lease&rental_features=&status=&listing_suburb_search_string=&listing_suburb_id=&surrounding_radius=6&listing_property_type=House&listing_property_type=Terrace&listing_property_type=Townhouse&LISTING_BEDROOMS=&LISTING_BATHROOMS=&CARPORTS=&LISTING_PRICE_FROM=&LISTING_PRICE_TO=&sort=date-desc&gallery&limit=12"
                ],
                "property_type": "house"
            },
            {
                "url": [
                    "https://pyrmontfn.com.au/json/data/listings/?authenticityToken=6OzvjunY3x9xCywPIhL2Cw%3D%3D&_method=post&input_types=&office_id=&listing_category=&staff_id=&postcode=&rental_features=&listing_sale_method=Lease&rental_features=&status=&listing_suburb_search_string=&listing_suburb_id=&surrounding_radius=6&listing_property_type=Studio&LISTING_BEDROOMS=&LISTING_BATHROOMS=&CARPORTS=&LISTING_PRICE_FROM=&LISTING_PRICE_TO=&sort=date-desc&gallery&limit=12"
                ],
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Pyrmontfn_PySpider_australia")
        ...
        furnished=response.xpath("//div[@class='description cp__item']//p//text()").getall()
        if furnished:
            for i in furnished:
        ...
        if landlord_name:
            ...
            item_loader.add_value("landlord_name", "FIRST NATIONAL REAL ESTATE | PYRMONT")
