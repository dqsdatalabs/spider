...
class MySpider(Spider):
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Eraouestrochelais_PySpider_"+ self.country + "_" + self.locale)

        rent="".join(response.xpath(
            "//div[@class='prix_bien']/p/span//text()").getall())
        if rent:
