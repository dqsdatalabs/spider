...
class MySpider(Spider):
    name = 'century21_immodissy_com'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source = "Century21immodissy_PySpider_france"
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21immodissy.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21immodissy.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Century21immodissy_PySpider_france", input_type="VALUE")
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 Immod'Issy")
        item_loader.add_value("landlord_phone", "01 46 44 80 00")
        item_loader.add_value("landlord_email", "immodissy@century21.fr")
