...
class MySpider(Spider):
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("landlord_name", "De Angelis Immobiliare")
        item_loader.add_value("landlord_phone", "3774890880")
        item_loader.add_value("landlord_email", "deangelisimmobiliareroma@gmail.com")
