...
class Braunschweig_homecompany_deSpider(Spider):
    name = 'braunschweig_homecompany_de'
    country='germany'
    locale='de' 
    external_source = "{}_PySpider_{}_{}".format(name.capitalize(), country, locale)
    execution_type='testing'
    allowed_domains = ["www.braunschweig.homecompany.de"]
    start_urls = ["https://braunschweig.homecompany.de/en/suchergebnis/noreset/1"]
    position = 1
    ...
    def populate_item(self, response):
        ...
        landlord_phone = "+ 49 (0) 531 - 19445"
        landlord_email = "braunschweig@homecompany.de"
