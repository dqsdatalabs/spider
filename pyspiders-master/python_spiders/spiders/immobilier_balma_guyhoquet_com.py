...
class MySpider(Spider):
    name = 'immobilier_balma_guyhoquet_com'
    execution_type='testing'
    country='france'
    locale='fr'
    headers = {
        'authority': 'balma.guy-hoquet.com',
        'accept': '*/*',
        ...
        'referer': 'https://balma.guy-hoquet.com/biens/result',
    ...
    def start_requests(self):
        start_urls = [
            ...
            {"url": "https://balma.guy-hoquet.com/biens/result?1&templates%5B%5D=properties&p=1&t=&filters%5B10%5D%5B%5D=2&filters%5B30%5D%5B%5D=appartement&with_markers=false&_=1609220354708", "property_type": "apartment"},
	        {"url": "https://balma.guy-hoquet.com/biens/result?1&templates%5B%5D=properties&p=1&t=&filters%5B10%5D%5B%5D=2&filters%5B30%5D%5B0%5D%5B%5D=maison&with_markers=false&_=1609220354710", "property_type": "house"},
        ] 
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Immobilier_Balma_Guyhoquet_PySpider_france", input_type="VALUE")
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_name", input_value="Guy Hoquet BALMA", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_phone", input_value="05 62 57 04 07", input_type="VALUE")
