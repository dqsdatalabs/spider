...
class MySpider(Spider):
    ...
    country='belgium'
    locale='nl'
    external_source='Hckinvest_PySpider_belgium'
    custom_settings = {
    ...
    headers={
            ...
            "origin": "https://hckinvest.be",
            "referer": "https://hckinvest.be/nl/te-huur/",
    ...
    def start_requests(self):
        ...
        for url in start_urls:
            ...
            payload={"Transaction":"0","Type":cod_tipologia,"City":"0","MinPrice":"0","MaxPrice":"0","MinSurface":"0","MaxSurface":"0","MinSurfaceGround":"0","MaxSurfaceGround":"0","MinBedrooms":"0","MaxBedrooms":"0","Radius":"0","NumResults":"15","StartIndex":1,"ExtraSQL":"0","ExtraSQLFilters":"0","NavigationItem":"0","PageName":"0","Language":"NL","CountryInclude":"0","CountryExclude":"0","Token":"DVTTNIDBCKYQDFNQVPKVOINGANWJCTEUBQTPSGGENQKHXBSIKW","SortField":"1","OrderBy":"2","UsePriceClass":False,"PriceClass":"0","SliderItem":"0","SliderStep":"0","CompanyID":"0","SQLType":"3","MediaID":"0","PropertyName":"0","PropertyID":"0","ShowProjects":False,"Region":"0","currentPage":"0","homeSearch":"0","officeID":"0","menuIDUmbraco":"0","investment":False,"useCheckBoxes":False,"CheckedTypes":"0","newbuilding":False,"bedrooms":0,"latitude":"0","longitude":"0","ShowChildrenInsteadOfProject":False,"state":"0","FilterOutTypes":""}
    ...
    def parse(self, response):
        ...
        for item in data:
            ...
            url=f"https://hckinvest.be/nl/te-huur/{country}/{type}/{id.split('/')[-1]}/"
