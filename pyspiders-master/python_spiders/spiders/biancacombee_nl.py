...
class MySpider(Spider):
    name = 'biancacombee_nl'
    execution_type = 'testing'
    country = 'netherlands'
    locale = 'nl'
    external_source = 'Biancacombee_PySpider_netherlands'

    # 1. FOLLOWING
    def start_requests(self): 
        formdata = {
            "huistype": "bovenwoning,galerijflat,overigog",
        ...
        yield FormRequest(
            "https://www.biancacombee.nl/huizen/smartselect.aspx",
            callback=self.jump,
            formdata=formdata,
            dont_filter=True,
            meta={
                "property_type":"apartment",
                "type" : "bovenwoning,galerijflat,overigog"
            })
    ...
    def jump(self, response):
        ...
        yield FormRequest(
            "https://www.biancacombee.nl/huizen/smartelement.aspx",
            callback=self.parse,
            formdata=formdata,
            dont_filter=True,
            meta={
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("landlord_name", "Bianca Combee Housing Service")
        item_loader.add_value("landlord_phone", "+31 (0)20 210 6000")
        item_loader.add_value("landlord_email", "info@biancacombee.nl")
