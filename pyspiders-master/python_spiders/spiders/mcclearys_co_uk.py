...
class MySpider(Spider):
    ...
    def start_requests(self):
        ...
        start_urls = [
            {
                "url" : [
                    "https://www.mcclearys.co.uk/search?sta=toLet&sta=let&st=rent&pt=residential&stygrp=3",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "https://www.mcclearys.co.uk/search?sta=toLet&sta=let&st=rent&pt=residential&stygrp=2&stygrp=10&stygrp=8&stygrp=9&stygrp=6",
                ],
                "property_type" : "house"
            },
        ]
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Mcclearys_Co_PySpider_united_kingdom")
        ...
        zipcode = "".join(response.xpath("//div[contains(@class,'ListingHeadline-address')]//span[contains(@class,'addressPostcode')]//text()").getall())
        if zipcode:
        ...
        item_loader.add_value("landlord_name", "McClearys")
        item_loader.add_value("landlord_phone", "028 9020 7111")
        item_loader.add_value("landlord_email", "office@mcclearys.co.uk")
