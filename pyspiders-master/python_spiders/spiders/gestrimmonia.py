...
class laforet(scrapy.Spider):
    ...
    def get_property_details(self, response, **kwargs):
        ...
        parking_type = response.xpath("//h2[.='Parking à louer  ']/text()").get()
        if parking_type:
            return
        ...
        item["rent"] = price
        item["landlord_name"] = "Gestrimmonia"
        item["landlord_phone"] = "08 003 08 003"
        item["landlord_email"] = "info@gestrimmonia.com"
