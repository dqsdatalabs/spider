...
class MySpider(Spider):
    name = 'immobilier_lattes_guyhoquet_com'
    execution_type='testing'
    country='france'
    locale='fr'
    # DYNAMIC VALUES
    gh_domain = "https://lattes.guy-hoquet.com"
    source_name = "Immobilier_Lattes_Guyhoquet_PySpider_france"
    landlord_n = "GUY HOQUET LATTES"
    landlord_p = "04 99 92 09 88"
    # --------------
    headers = {
    ...
    def populate_item(self, response):
        ...
        if response.xpath("//div[@id='intro']//i[contains(@class,'bed')]/following-sibling::div/text()"):
            ...
            ItemClear(response=response, item_loader=item_loader, item_name="room_count", input_value="//div[@id='intro']//i[contains(@class,'room')]/following-sibling::div/text()", input_type="F_XPATH", get_num=True, split_list={" ":0})
