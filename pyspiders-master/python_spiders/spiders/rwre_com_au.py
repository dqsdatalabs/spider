...
class MySpider(Spider):
    ...
    country='australia'
    locale='en'
    external_source='Rwre_PySpider_australia'
    custom_settings = {
    ...
    def start_requests(self):
        headers={
            ...
            "cookie": "_gcl_au=1.1.2031296305.1641907074; _ga=GA1.3.1796121411.1641907077; _gid=GA1.3.1191558069.1641907077; __adroll_fpc=f11d1e6502aac3be01dbdbcc349bdc5c-1641989524128; _fbp=fb.2.1641989524876.585620128; __ar_v4=ZX5C2L42ZBB4BBSL3MMBKA%3A20220111%3A7%7CGLWESRX7ZVGT5FHMFJ5WGT%3A20220111%3A7%7CD3ZBI6JPXBE7PEQ6IC2ZSI%3A20220111%3A7; _dc_gtm_UA-79146502-2=1; _gat_UA-6527203-1=1; _gat_UA-27709243-49=1",
            "upgrade-insecure-requests": "1",
            "user-agent": "Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Mobile Safari/537.36",
        }

        start_urls = [
            {"url": "http://rwre.com.au/properties/residential-for-rent?category=&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode="},
    ...
    def populate_item(self, response):
        ...
        if rent:
            ...
            for i in a:
                if "pcm" in i:
                    item_loader.add_value("rent",i.split("pcm")[0].split("$")[-1].replace(".",""))
                if "bond" in i.lower():
                    item_loader.add_value("deposit",i.split("Bond")[0].split("$")[-1].replace(".",""))
