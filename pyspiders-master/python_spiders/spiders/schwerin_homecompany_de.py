...
class Schwerin_homecompany_deSpider(Spider):
    name = 'schwerin_homecompany_de'
    country='germany'
    locale='de' 
    external_source = "{}_PySpider_{}_{}".format(name.capitalize(), country, locale)
    execution_type='testing'
    allowed_domains = ["www.schwerin.homecompany.de"]
    start_urls = ["https://schwerin.homecompany.de/en/suchergebnis/noreset/1"]
    position = 1
    ...
    def populate_item(self, response):
        ...
        landlord_phone = "+ 0049 (0) 385 - 19445"
        landlord_email = "schwerin@homecompany.de"
