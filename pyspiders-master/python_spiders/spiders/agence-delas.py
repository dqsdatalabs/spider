...
class QuotesSpider(scrapy.Spider):
    ...
    def get_property_details(self, response):
        ...
        room_count = response.xpath("//p[@class='data']/span[contains(.,'Nombre de pièces')]/following-sibling::span/text()").get()
        if room_count:
        ...
        utilities = response.xpath("//p[@class='data']/span[contains(.,'Charges locatives')]/following-sibling::span/text()").get()
        if utilities:
        ...
        item["landlord_name"] = 'AGENCE DELAS'
