...
class MySpider(Spider):
    name = 'century21_lgimontpellier_com'
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-lgi-montpellier.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-lgi-montpellier.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21lgimontpellier_PySpider_"+ self.country + "_" + self.locale)
        ...
        item_loader.add_value("landlord_phone", "04 67 52 00 14")
        item_loader.add_value("landlord_name", "CENTURY 21 LGI")
