...
class MySpider(Spider):
    name = 'goodinvestgayrimenkul_net'
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : "http://goodinvestgayrimenkul.net/kiralik-daire?pagingSize=9&sorting=date_desc",
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Goodinvestgayrimenkul_PySpider_"+ self.country + "_" + self.locale)
