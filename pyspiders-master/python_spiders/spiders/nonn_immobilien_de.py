...
class Nonn_immobilienDeSpider(scrapy.Spider):
    name = 'nonn_immobilien_de'
    page_number = 1
    start_urls = [
        f'https://homepagemodul.immowelt.de/list/api/list/?callback=listcallback&guid=ebfe60e423f2488897c4ca2f1130c703&area=&eType=-1&eCat=-1&geoid=-1&livingarea=&page={page_number}&price=&rentfactor=&room=&squareprice=&windowarea=&stype=0'
    ]
    country = 'germany'
    locale = 'de'
    ...
    formdatas = f'callback=listcallback&guid=ebfe60e423f2488897c4ca2f1130c703&area=&eType=-1&eCat=-1&geoid=-1&livingarea=&page={page_number}&price=&rentfactor=&room=&squareprice=&windowarea=&stype=0'
    header = {
        'Host': 'homepagemodul.immowelt.de',
        'referer': 'https://nonn-immobilien.de/',
    ...
    def parse(self, response, **kwargs):
        ...
        for rental in rentals:
            formdata = f'callback=exposecallback&guid=ebfe60e423f2488897c4ca2f1130c703&id={rental}&isVorschau=&isStatistic=false&_=1642086722828'
            yield scrapy.FormRequest(url=f'https://homepagemodul.immowelt.de/home/api/Expose/?callback=exposecallback&guid=ebfe60e423f2488897c4ca2f1130c703&id={rental}&isVorschau=&isStatistic=false&_=1642086722828',
        ...
        if page['Â»'] !='#':
            self.page_number +=1
            yield scrapy.FormRequest(f'https://homepagemodul.immowelt.de/list/api/list/?callback=listcallback&guid=ebfe60e423f2488897c4ca2f1130c703&area=&eType=-1&eCat=-1&geoid=-1&livingarea=&page={self.page_number}&price=&rentfactor=&room=&squareprice=&windowarea=&stype=0', callback=self.parse, body=self.formdatas, headers=self.header, method='GET')
    ...
    def populate_item(self, response):
        ...
        address = ' '.join(internal_response.css('#hm_energy+ .hm_expose_half_width span ::text').extract())
        ...
        if rent:
            ...
            # # MetaData
            item_loader.add_value("external_link", f'https://nonn-immobilien.de/vermietung/#/expose{response.meta["id"]}')  # String
            ...
            # # LandLord Details
            item_loader.add_value("landlord_name", 'NONN Immobilien GmbH') # String
            item_loader.add_value("landlord_phone", '0531/6183600') # String
            item_loader.add_value("landlord_email", 'info@nonn-immobilien.de') # String
