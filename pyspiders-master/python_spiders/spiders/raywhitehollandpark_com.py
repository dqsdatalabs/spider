...
class MySpider(Spider):
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : [
                    "https://raywhitehollandpark.com.au/properties/residential-for-rent?category=APT%7CUNT&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "https://raywhitehollandpark.com.au/properties/residential-for-rent?category=HSE%7CTCE%7CTHS&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
                "property_type" : "house"
            },
            {
                "url" : [
                    "https://raywhitehollandpark.com.au/properties/residential-for-rent?category=STD&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Raywhitehollandpark_PySpider_australia") 
        ...
        if price:
            rent = price.split("/")[1].split("$")[1].split("Bond")[0].strip().replace(",","")
        ...
        item_loader.add_value("landlord_name", "Ray White Holland Park")
        item_loader.add_value("landlord_phone", "+61 3421 1600")
        item_loader.add_value("landlord_email", "hollandpark.qld@raywhite.com")
