...
class MySpider(Spider):
    name = 'cabinetclemenceau_com' 
    execution_type='testing'
    country='france'
    locale='fr'
    post_url = "https://www.cabinetclemenceau.com/recherche/"
    current_index = 0
    other_prop = ["4"]
    other_type = ["studio"]
    custom_settings = { 
    ...
    def parse(self, response):
        ...
        if page == 2 or seen:            
            p_url = f"https://www.cabinetclemenceau.com/recherche/{page}"
            yield Request(
                p_url,
                callback=self.parse,
                dont_filter=True,
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Cabinetclemenceau_PySpider_france")
        ...
        item_loader.add_value("landlord_name", "CABINET CLEMENCEAU")
        item_loader.add_value("landlord_phone", "04 97 21 60 60")
        item_loader.add_value("landlord_email", "florence@cabinetclemenceau.com")
