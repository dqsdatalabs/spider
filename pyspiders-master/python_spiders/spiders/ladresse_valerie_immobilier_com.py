...
class MySpider(Spider):
    name = 'ladresse_valerie_immobilier_com'
    execution_type='testing'
    country='france'
    locale='fr'
    def start_requests(self):
        start_urls = [
            {"url": "https://www.ladresse-valerie-immobilier.com/catalog/result_carto.php?action=update_search&C_28=Location&C_28_search=EGAL&C_28_type=UNIQUE&site-agence=&C_65_search=CONTIENT&C_65_type=TEXT&C_65=&C_27_search=EGAL&C_27_type=TEXT&C_27=1&C_27_tmp=1&C_30_search=COMPRIS&C_30_type=NUMBER&C_30_MIN=&C_30_MAX=&30_MIN=&30_MAX=", "property_type": "apartment"},
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Ladresse_Valerie_Immobilier_PySpider_france")
        ...
        item_loader.add_value("landlord_name", "L'ADRESSE Alfortville")
        item_loader.add_value("landlord_phone", "01 41 79 31 22")
        item_loader.add_value("landlord_email", "valerie.immobilier@ladresse.com")
