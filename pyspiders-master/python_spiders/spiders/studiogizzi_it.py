...
class MySpider(Spider):
    ...
    def populate_item(self, response):
        ...
        external_id = sel.xpath("//li[span[contains(.,'Riferimento')]]/span[2]/text()").get()
        if external_id:
        ...
        item_loader.add_value("landlord_name", "Studio Gizzi Immobiliare")
        item_loader.add_value("landlord_phone", "0648930218")
        item_loader.add_value("landlord_email", "info@studiogizzi.it")
