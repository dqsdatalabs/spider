...
class MySpider(Spider):
    name = 'immobilier_cuers_guyhoquet_com'
    execution_type='testing'
    country='france'
    locale='fr'
    # DYNAMIC VALUES
    gh_domain = "https://cuers.guy-hoquet.com"
    source_name = "Immobilier_Cuers_Guyhoquet_PySpider_france"
    landlord_n = "GUY HOQUET CUERS"
    landlord_p = "04 94 14 35 66"
    # --------------
    headers = {
