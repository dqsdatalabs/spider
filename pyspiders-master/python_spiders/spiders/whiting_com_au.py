...
class MySpider(Spider):
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : [
                    "https://whiting.com.au/search/?show_in_rental=true&sold=0&order_by=listing_date&order=desc&localities=&postal_code=&status=rent&suburb-box=&property_types=apartment&min_price=&max_price=&min_bedrooms=&min_bathrooms=&min_carparks=&min_land_size=&land_size_units=m2",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "https://whiting.com.au/search/?show_in_rental=true&sold=0&order_by=listing_date&order=desc&localities=&postal_code=&status=rent&suburb-box=&property_types=house&min_price=&max_price=&min_bedrooms=&min_bathrooms=&min_carparks=&min_land_size=&land_size_units=m2",
                    "https://whiting.com.au/search/?show_in_rental=true&sold=0&order_by=listing_date&order=desc&localities=&postal_code=&status=rent&suburb-box=&property_types=townhouse&min_price=&max_price=&min_bedrooms=&min_bathrooms=&min_carparks=&min_land_size=&land_size_units=m2",
                ],
                "property_type" : "house"
            },
            {
                "url" : [
                    "https://whiting.com.au/search/?show_in_rental=true&sold=0&order_by=listing_date&order=desc&localities=&postal_code=&status=rent&suburb-box=&property_types=studio&min_price=&max_price=&min_bedrooms=&min_bathrooms=&min_carparks=&min_land_size=&land_size_units=m2",
                ],
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Whiting_Com_PySpider_australia", input_type="VALUE")
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="rent", input_value="//div[@class='price']/text()[contains(.,'$')]", input_type="F_XPATH", get_num=True, per_week=True)
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="deposit", input_value="//div[@class='tab-content']//p//text()[contains(.,'Bond')]", input_type="F_XPATH", get_num=True)
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_id", input_value="//div[@class='tab-content']//p//text()[contains(.,'Property ID')]", input_type="F_XPATH", split_list={":":1})
