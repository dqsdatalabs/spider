...
class ImmobilienWypiorDeSpider(scrapy.Spider):
    name = "immobilien_wypior_de"
    start_urls = [
        'https://www.casa-id.de/immobilienangebote/?_search=true&mt=rent&category=14&address=&sort=sort%7Cdesc#immobilien',
        'https://www.casa-id.de/immobilienangebote/?_search=true&mt=rent&category=10&address=&sort=sort%7Cdesc#immobilien',
        'https://www.casa-id.de/immobilienangebote/?_search=true&mt=rent&category=15&address=&sort=sort%7Cdesc#immobilien'
    ]
    ...
    def populate_item(self, response):
        ...
        energy_label = None
        if "Energieeffizienzklasse:" in details or "schwer\nEnergieeffizienzklasse:" in details:
            position = details.index("Energieeffizienzklasse:")
            energy_label = (details[position + 1])[0]
        ...
        if rent != "Preis auf Anfrage":
            ...
            # # LandLord Details
            item_loader.add_value("landlord_name", "CASA- Immobilien Dienstleistungs GmbH")  # String
            item_loader.add_value("landlord_phone", "02331 36789-10")  # String
            item_loader.add_value("landlord_email", "info@casa-id.de")  # String
