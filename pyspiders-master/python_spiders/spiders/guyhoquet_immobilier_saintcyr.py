...
class MySpider(Spider):
    name = 'guyhoquet_immobilier_saintcyr'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source = "Guyhoquet_Immobilier_Saintcyr_PySpider_france"

    gh_domain = "https://saint-cyr-sur-loire.guy-hoquet.com"
    headers = {
    ...
    def get_token(self, response):
        ...
        start_urls = [
            {"url": f"{self.gh_domain}/biens/result?1&templates%5B%5D=properties&p=1&t=&filters%5B10%5D%5B%5D=2&filters%5B30%5D%5B0%5D%5B%5D=appartement&with_markers=false&with_map=false&_=1632825427545", 
                "property_type": "apartment"},
            {"url": f"{self.gh_domain}/biens/result?1&templates%5B%5D=properties&p=1&t=&filters%5B10%5D%5B%5D=2&filters%5B30%5D%5B0%5D%5B%5D=maison&with_markers=false&with_map=false&_=1632825427547", 
            "property_type": "house"}
        ] 
