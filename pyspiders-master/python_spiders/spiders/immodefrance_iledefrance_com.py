...
class MySpider(Spider):
    name = 'immodefrance_iledefrance_com'    
    execution_type='testing'
    country='france'
    locale='fr'
    external_source = "Immodefrance_Iledefrance_PySpider_france"
    custom_settings = {
        "PROXY_ON":True,
    }
    ...
    def start_requests(self, **kwargs):
        ...
        for key, value in kwargs.items():
            ...
            yield FormRequest("https://www.immodefrance-iledefrance.com/fr/locations",
                            callback=self.parse,
                            formdata=formdata,
    ...
    def parse(self, response):
        ...
        if page == 20 or seen:
            p_url = f"https://www.immodefrance-iledefrance.com/fr/map/mini-fiche/Location/{page}/normal/loyerCcTtcMensuel%7Casc"
            yield Request(
                p_url,
                dont_filter=True,
                callback=self.parse,
    ...
    def populate_item(self, response):
        ...
        terrace=response.xpath("//div[@class='criteres']/div/text()[contains(.,'Terrasse')]").get()
        if terrace:
            item_loader.add_value("terrace",True)


        item_loader.add_value("landlord_phone", "01 40 82 69 50")
        item_loader.add_value("landlord_name", "IMMO de France Iledefrance")
