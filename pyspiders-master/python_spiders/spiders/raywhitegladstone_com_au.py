...
class MySpider(Spider):
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : [
                    "https://raywhitegladstone.com.au/properties/residential-for-rent?category=APT%7CUNT&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "https://raywhitegladstone.com.au/properties/residential-for-rent?category=HSE%7CTCE%7CTHS&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
                "property_type" : "house"
            },
            {
                "url" : [
                    "https://raywhitegladstone.com.au/properties/residential-for-rent?category=STD&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Raywhitegladstone_Com_PySpider_australia", input_type="VALUE")
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="zipcode", input_value="//h1[contains(@class,'pdp_address')]/span/text()", input_type="F_XPATH", split_list={",":-1}, replace_list={"QLD":""})
        ...
        parking = "".join(response.xpath("//div[@class='pdp_header']//li[@class='car']/span/text()").getall())
        if parking:
            if int(parking) > 0:
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_name", input_value="Ray White Gladstone", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_phone", input_value="61 (7) 4972 3288", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_email", input_value="gladstone.qld@raywhite.com", input_type="VALUE")
