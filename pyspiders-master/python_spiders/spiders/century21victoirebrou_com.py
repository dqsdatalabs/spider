...
class MySpider(Spider):
    name = 'century21victoirebrou_com'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source = "Century21victoirebrou_PySpider_france_fr"
    custom_settings = {
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-victoire-brou.com/annonces/location/?types_biens=appartement&xhr=true", "property_type": "apartment"},
	        {"url": "https://www.century21-victoire-brou.com/annonces/location/?types_biens=maison&xhr=true", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 Victoire Immobilier")
        item_loader.add_value("landlord_phone", "01 64 21 54 54")
        item_loader.add_value("landlord_email", "victoire@century21.fr")
