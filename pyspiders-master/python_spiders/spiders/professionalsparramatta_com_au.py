...
class MySpider(Spider):
    name = 'professionalsparramatta_com_au'
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : [
                    "https://www.professionalsparramatta.com.au/search/?show_in_rental=true&sold=0&order_by=listing_date&order=desc&localities=&postal_code=&status=rent&suburb-box=&property_types=flat&min_price=&max_price=&min_bedrooms=&min_bathrooms=&min_carparks=&min_land_size=&land_size_units=m2",
                    "https://www.professionalsparramatta.com.au/search/?show_in_rental=true&sold=0&order_by=listing_date&order=desc&localities=&postal_code=&status=rent&suburb-box=&property_types=unit&min_price=&max_price=&min_bedrooms=&min_bathrooms=&min_carparks=&min_land_size=&land_size_units=m2",
                    "https://www.professionalsparramatta.com.au/search/?show_in_rental=true&sold=0&order_by=listing_date&order=desc&localities=&postal_code=&status=rent&suburb-box=&property_types=apartment&min_price=&max_price=&min_bedrooms=&min_bathrooms=&min_carparks=&min_land_size=&land_size_units=m2",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "https://www.professionalsparramatta.com.au/search/?show_in_rental=true&sold=0&order_by=listing_date&order=desc&localities=&postal_code=&status=rent&suburb-box=&property_types=house&min_price=&max_price=&min_bedrooms=&min_bathrooms=&min_carparks=&min_land_size=&land_size_units=m2",
                    "https://www.professionalsparramatta.com.au/search/?show_in_rental=true&sold=0&order_by=listing_date&order=desc&localities=&postal_code=&status=rent&suburb-box=&property_types=penthouse&min_price=&max_price=&min_bedrooms=&min_bathrooms=&min_carparks=&min_land_size=&land_size_units=m2",
                ],
                "property_type" : "house"
            },
            {
                "url" : [
                    "https://www.professionalsparramatta.com.au/search/?show_in_rental=true&sold=0&order_by=listing_date&order=desc&localities=&postal_code=&status=rent&suburb-box=&property_types=studio&min_price=&max_price=&min_bedrooms=&min_bathrooms=&min_carparks=&min_land_size=&land_size_units=m2",
                ],
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Professionalsparramatta_Com_PySpider_australia", input_type="VALUE")
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="rent", input_value="//div[@class='price']/text()[contains(.,'$') or contains(.,'P/W')]", input_type="F_XPATH", get_num=True, per_week=True, split_list={" ":0, ".":0})
        ...
        zipcode = response.xpath("//div[@class='address']/text()").get()
        if zipcode:
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="available_date", input_value="//div[@class='tab-content']//p//text()[contains(.,'Available')]", input_type="M_XPATH", split_list={":":1})
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_phone", input_value="//div[@class='agent-wrapper']//span[contains(.,'Office')]/a/text()", input_type="F_XPATH")
