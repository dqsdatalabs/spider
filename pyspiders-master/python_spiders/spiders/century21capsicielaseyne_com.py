...
class MySpider(Spider):
    name = 'century21capsicielaseyne_com'
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-cap-sicie-la-seyne.com/annonces/location/v-la+seyne+sur+mer/?types_biens=appartement&xhr=true", "property_type": "apartment"},
	        {"url": "https://www.century21-cap-sicie-la-seyne.com/annonces/location/v-la+seyne+sur+mer/?types_biens=maison&xhr=true", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21capsicielaseyne_PySpider_"+ self.country + "_" + self.locale)
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 Cap Sicié")
