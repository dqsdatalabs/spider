...
class MySpider(Spider):
    name = 'century21_val_europe_serris_com'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source='Century21_Val_Europe_Serris_PySpider_france'
    # custom_settings = {
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-val-europe-serris.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-val-europe-serris.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_name", input_value="CENTURY 21 Immobilier Val d'Europe", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_email", input_value="Ag2212@Century21France.fr", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_phone", input_value="01 60 43 28 88", input_type="VALUE")
