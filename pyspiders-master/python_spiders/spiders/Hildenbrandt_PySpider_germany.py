...
class HildenbrandtPyspiderGermanySpider(scrapy.Spider):
    name = "Hildenbrandt"
    start_urls = [
        'https://portal.immobilienscout24.de/ergebnisliste/49566907',
        'https://portal.immobilienscout24.de/ergebnisliste/49566907/2?sid=hfjpuu2kg9acgr0bl150a5t8h1'
    ]
    allowed_domains = ["hildenbrandt.de", "portal.immobilienscout24.de"]
    ...
    def parse(self, response, **kwargs):
        ...
        for apartment_div in apartments_divs:
            rent_type = apartment_div.xpath(
                './/div[contains(@class, "result__list__element--infos")]//p/text()').extract()
            rent_type_final = []
            if rent_type:
    ...
    def populate_item(self, response):
        ...
        landlord_name = "Hildenbrandt GmbH"
        landlord_number = "+49 711 6679 - 230"
        landlord_email = "info@hildenbrandt-vermietung.de"
