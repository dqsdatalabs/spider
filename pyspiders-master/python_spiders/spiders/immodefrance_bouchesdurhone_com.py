...
class MySpider(Spider):
    name = 'immodefrance_bouchesdurhone_com'    
    ...
    external_source = "Immodefrance_Bouchesdurhone_PySpider_france"
    ...
    def start_requests(self, **kwargs):
        ...
        for key, value in kwargs.items():
            ...
            yield FormRequest("https://www.immodefrance-bouchesdurhone.com/fr/locations",
                            callback=self.parse,
                            formdata=formdata,
    ...
    def parse(self, response):
        ...
        if page == 20 or seen:
            p_url = f"https://www.immodefrance-bouchesdurhone.com/fr/map/mini-fiche/Location/{page}/normal/loyerCcTtcMensuel%7Casc"
            yield Request(
                p_url,
                dont_filter=True,
                callback=self.parse,
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("landlord_phone", "04 96 11 66 66")
        item_loader.add_value("landlord_name", "IMMO de France Bouchesdurhone")
