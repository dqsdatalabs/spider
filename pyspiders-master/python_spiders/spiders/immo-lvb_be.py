...
class MySpider(Spider):
    ...
    country='belgium'
    locale='nl'
    external_source='Immolvb_PySpider_belgium'
    custom_settings = {
        "HTTPCACHE_ENABLED": False
    }
    headers={
            "content-type": "application/json",
            "cookie": "ASP.NET_SessionId=ucd5x33zb1jowb3qzqunrynv; _ga=GA1.2.1310627888.1641535442; _gid=GA1.2.1908907714.1641535442",
            "origin": "https://immo-lvb.be",
            "referer": "https://immo-lvb.be/nl/te-huur/",
    ...
    def start_requests(self):
        ...
        for url in start_urls:
            ...
            payload={"Transaction":"0","Type":cod_tipologia,"City":"0","MinPrice":"0","MaxPrice":"0","MinSurface":"0","MaxSurface":"0","MinSurfaceGround":"0","MaxSurfaceGround":"0","MinBedrooms":"0","MaxBedrooms":"0","Radius":"0","NumResults":"15","StartIndex":1,"ExtraSQL":"0","ExtraSQLFilters":"0","NavigationItem":"0","PageName":"0","Language":"NL","CountryInclude":"0","CountryExclude":"0","Token":"YPFHLEWQXCTQYUHJEYGQUQTQENJRSSQPLEXHMCNUKBJXVLZMUU","SortField":"1","OrderBy":1,"UsePriceClass":False,"PriceClass":"0","SliderItem":"0","SliderStep":"0","CompanyID":"0","SQLType":"3","MediaID":"0","PropertyName":"0","PropertyID":"0","ShowProjects":False,"Region":"0","currentPage":"0","homeSearch":"0","officeID":"0","menuIDUmbraco":"0","investment":False,"useCheckBoxes":False,"CheckedTypes":"0","newbuilding":False,"bedrooms":0,"latitude":"0","longitude":"0","ShowChildrenInsteadOfProject":False,"state":"0","FilterOutTypes":""}
            mainurl="https://immo-lvb.be/Modules/ZoekModule/RESTService/SearchService.svc/GetPropertiesJSON/0/0"
            if url:
    ...
    def parse(self, response):
        ...
        for item in data:
            ...
            url=f"https://immo-lvb.be/nl/te-huur/{country}/{type}/{id.split('/')[-1]}/"
    ...
    def populate_item(self, response):
        ...
        dontallow=response.xpath("//div[@class='shortinfo']/h2/text()").get()
        if dontallow and "koop" in dontallow:
            return 
        ...
        square_meters=response.xpath("//label[contains(.,'Bewoonbare opp')]/following-sibling::text()").get()
        if square_meters:
