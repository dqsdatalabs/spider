...
class MySpider(Spider):
    name = 'paris15saintcharles_guy_hoquet_com'
    ...
    headers = {
        ...
        'referer': "https://paris-15-saint-charles.guy-hoquet.com/biens/result",
    ...
    def start_requests(self):
        start_urls = [
            ...
            {"url": "https://paris-15-saint-charles.guy-hoquet.com/biens/result?1&templates%5B%5D=properties&p=1&t=&filters%5B10%5D%5B%5D=2&filters%5B30%5D%5B0%5D%5B%5D=appartement&with_markers=false&_=1603886161981", "property_type": "apartment"},
	        {"url": "https://paris-15-saint-charles.guy-hoquet.com/biens/result?1&templates%5B%5D=properties&p=1&t=&filters%5B10%5D%5B%5D=2&filters%5B30%5D%5B0%5D%5B%5D=maison&with_markers=false&_=1603886161983", "property_type": "house"},
        ] 
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Paris15saintcharles_guy_hoquet_PySpider_"+ self.country + "_" + self.locale)
        ...
        bathroom_count="".join(response.xpath(
            "//div[@class='biens-list']//div/i[contains(@class,'ico bath')]/parent::div//text()").getall())
        if bathroom_count:
        ...
        parking="".join(response.xpath(
            "//div[@class='biens-list']//div/i[contains(@class,'parking')]/parent::div//text()").getall())
        if parking:
