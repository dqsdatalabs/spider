...
class MySpider(Spider):
    name = 'century21_gambettalemans_com'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source =  "Century21_gambettalemans_PySpider_france"

    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-gambetta-le-mans.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-gambetta-le-mans.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
