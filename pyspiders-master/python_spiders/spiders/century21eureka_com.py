...
class MySpider(Spider):
    name = 'century21eureka_com'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source = "Century21eureka_PySpider_france_fr"
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21eureka.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21eureka.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        title = response.css("h1.h1_page").get()
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 Eureka")
        item_loader.add_value("landlord_phone", "01 49 84 19 92")
        item_loader.add_value("landlord_email", "eureka@century21.fr")
