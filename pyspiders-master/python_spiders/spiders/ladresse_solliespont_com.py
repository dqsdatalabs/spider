...
class MySpider(Spider):
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : "https://www.ladresse-solliespont.com/catalog/advanced_search_result.php?action=update_search&C_28=Location&C_28_search=EGAL&C_28_type=UNIQUE&site-agence=&C_65_search=CONTIENT&C_65_type=TEXT&C_65=&C_27_search=EGAL&C_27_type=TEXT&C_27=1&C_27_tmp=1&C_30_search=COMPRIS&C_30_type=NUMBER&C_30_MIN=&C_30_MAX=&30_MIN=&30_MAX=",
...
# 2. SCRAPING level 2
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Ladresse_Solliespont_PySpider_france")
        ...
        rent = response.xpath("//div[contains(@class,'prix')]//span[contains(@class,'alur_loyer_price')]//text()").extract_first()
        if rent:
            rent = rent.split('Loyer')[1].encode("ascii", "ignore").decode().split('.')[0].strip()
        ...
        item_loader.add_value("landlord_name", "L'ADRESSE")
        item_loader.add_value("landlord_phone", "04 94 33 88 80")
