...
class MySpider(Spider):
    name = 'century21_raspail_com'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source = "Century21raspail_PySpider_france"
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21raspail.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21raspail.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Century21raspail_PySpider_france", input_type="VALUE")
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 Raspail")
        item_loader.add_value("landlord_phone", "01 72 36 55 50")
