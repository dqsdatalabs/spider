...
class ClhomeDeSpider(scrapy.Spider):
    name = 'clhome_de'
    # allowed_domains = ['clhome.de']
    start_urls = ['https://portal.immobilienscout24.de/ergebnisliste/76091452']  # https not http
    country = 'germany'
    locale = 'en'
    ...
    def populate_item(self, response):
        ...
        # # LandLord Details
        item_loader.add_value("landlord_name", 'Mrs. Christiane Lembert') # String
        item_loader.add_value("landlord_phone", '01512 9132931') # String
        item_loader.add_value("landlord_email", 'christiane.lembert@clhome.de') # String
