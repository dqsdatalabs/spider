...
class MySpider(Spider):
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : [
                    "https://lsre.com.au/double-bay/wp-json/api/listings/all?priceRange=&category=Apartment&limit=18&type=rental&status=current&address=&paged=1",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "https://lsre.com.au/double-bay/wp-json/api/listings/all?priceRange=&category=House%2CTownhouse%2CVilla&limit=18&type=rental&status=current&address=&paged=1",
                ],
                "property_type" : "house"
            },
            {
                "url" : [
                    "https://lsre.com.au/double-bay/wp-json/api/listings/all?priceRange=&category=Studio&limit=18&type=rental&status=current&address=&paged=1",
                ],
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Lsdb_Com_PySpider_australia", input_type="VALUE")
