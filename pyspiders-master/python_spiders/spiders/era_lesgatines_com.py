...
class MySpider(Spider):
    name = 'era_lesgatines_com'
    execution_type='testing'
    country='france'
    locale='fr'
    # DYNAMIC DATA
    b_url = "https://www.era-immobilier-plaisir.fr"
    source_name = "Era_Lesgatines_PySpider_france"
    # --------------
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_phone", input_value="//div[@class='contact_nego_boutons_return']/a//text()", input_type="M_XPATH", split_list={" ":0})
        ...
        zipcode = response.xpath("//span[contains(@class,'ville')]//text()").get()
        if zipcode:
