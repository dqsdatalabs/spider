...
class Immo24_heuchertDeSpider(scrapy.Spider):
    name = 'immo24_heuchert_de'
    start_urls = ['https://system.ivd24immobilien.de/objektliste/1698?page=1&sort=id&standort=&objektart=&vermarktungsart=&preisbis=&zimmerab=&flaecheab=&baujahrab=']  # https not http
    country = 'germany'
    locale = 'de'
    ...
    headers = {
        ...
        'Origin': 'https://immo24-heuchert.de',
    'Referer': 'https://immo24-heuchert.de',
    }
    duplicate = {}
    ...
    def parse(self, response, **kwargs):
        ...
        for rental in rentals:
            yield scrapy.FormRequest(url=f'https://system.ivd24immobilien.de/objektliste/expose/{rental}?objektliste=1698',
        ...
        if not 'geschäftshaus' in title.lower():
            ...
            if property_type:
                ...
                if 'Verf gbar ab' in list_items_dict.keys():
                    available_date = list_items_dict['Verf gbar ab']
                ...
                if rent:
                    ...
                    landlord_name = [i for i in landlord_name if 'herr' in i.lower() or 'frau' in i.lower()]
                    landlord_name = landlord_name[0]
                    landlord_email = 'info@heuchert-immobilien.de'
                    ...
                    # # MetaData
                    item_loader.add_value("external_link", 'https://immo24-heuchert.de/aktuelle-objekte/#'+str(self.position)) # String
