...
class MySpider(Spider):
    name = 'century21_alpha_paris6_com'
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-alpha-paris-6.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-alpha-paris-6.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Century21_Alpha_Paris_6_PySpider_france", input_type="VALUE")
        ...
        item_loader.add_value('landlord_phone','01 44 07 13 13')
        item_loader.add_value('landlord_email','alphasaintgermain@century21.fr')
