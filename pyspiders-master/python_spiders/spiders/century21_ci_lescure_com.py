...
class MySpider(Spider):
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-ci-lescure.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-ci-lescure.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Century21_Ci_Lescure_PySpider_france", input_type="VALUE")
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_name", input_value="CENTURY 21 Cap Immobilier", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_phone", input_value="05 63 36 18 25", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_email", input_value="cap-immobilier@century21.fr", input_type="VALUE")
