...
class Oldenburg_homecompany_deSpider(Spider):
    name = 'oldenburg_homecompany_de'
    country='germany'
    locale='de' 
    external_source = "{}_PySpider_{}_{}".format(name.capitalize(), country, locale)
    execution_type='testing'
    allowed_domains = ["www.oldenburg.homecompany.de"]
    start_urls = ["https://oldenburg.homecompany.de/en/suchergebnis/noreset/1"]
    position = 1
    ...
    def populate_item(self, response):
        ...
        landlord_phone = "+ 49 (0) 441 - 20572475"
        landlord_email = "oldenburg@homecompany.de"
