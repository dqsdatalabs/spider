...
class MySpider(Spider):
    name = 'vestingvastgoed_nl'
    execution_type = 'testing'
    country = 'netherlands'
    locale = 'nl'
    start_urls = ["https://www.vestingvastgoed.nl/nl/realtime-listings/consumer"]
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Vestingvastgoed_PySpider_netherlands")
        ...
        images = [response.urljoin(x) for x in response.xpath("//div[@class='responsive-slider-slides']//img/@src").getall()]
        if images:
        ...
        item_loader.add_value("landlord_name", "Vesting Vastgoed")
        item_loader.add_value("landlord_phone", "070 - 365 06 65")
        item_loader.add_value("landlord_email", "info@vestingvastgoed.nl")
