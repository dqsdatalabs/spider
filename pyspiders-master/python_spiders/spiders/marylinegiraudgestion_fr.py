...
class MySpider(Spider):
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_id", input_value="//li[contains(.,'Réf')]/strong//text()", input_type="F_XPATH")
        ItemClear(response=response, item_loader=item_loader, item_name="address", input_value="//li[contains(.,'Ville') or contains(.,'Département')]/strong//text()", input_type="M_XPATH")
        ...
        if response.xpath("//li[contains(.,'pièces')]/strong//text()").get():
            ItemClear(response=response, item_loader=item_loader, item_name="room_count", input_value="//li[contains(.,'pièces')]/strong//text()", input_type="F_XPATH", get_num=True)
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="available_date", input_value="//li[contains(.,'Disponibilité')]/strong/text()", input_type="F_XPATH")
        ItemClear(response=response, item_loader=item_loader, item_name="deposit", input_value="//li[contains(.,'Dépot de garantie')]/strong/text()", input_type="F_XPATH", get_num=True, split_list={"€":0})
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="furnished", input_value="//li[contains(.,'Meublé')]/strong//text()[contains(.,'oui')]", input_type="F_XPATH", tf_item=True)
