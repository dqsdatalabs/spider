...
class MySpider(Spider):
    name = 'century21_artimmo_maubeuge_com'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source =  "Century21_Artimmo_Maubeuge_PySpider_france"
    # custom_settings = {
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-artimmo-maubeuge.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-artimmo-maubeuge.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("landlord_name", "Century 21 Art-Immo")
