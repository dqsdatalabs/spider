...
class MySpider(Spider):
    name = 'raywhitecraigieburn_com_au'
    ...
    def start_requests(self):
        start_urls = [
            {
                "url" : [
                    "https://raywhitecraigieburn.com.au/properties/residential-for-rent?category=APT%7CUNT&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "https://raywhitecraigieburn.com.au/properties/residential-for-rent?category=HSE%7CTCE%7CTHS&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
                "property_type" : "house"
            },
            {
                "url" : [
                    "https://raywhitecraigieburn.com.au/properties/residential-for-rent?category=STD&keywords=&minBaths=0&minBeds=0&minCars=0&rentPrice=&sort=updatedAt+desc&suburbPostCode=",
                ],
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Raywhitecraigieburn_Com_PySpider_australia", input_type="VALUE")
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_name", input_value="Ray White Craigieburn", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_phone", input_value="61 (3) 9308 2277", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_email", input_value="craigieburn.vic@raywhite.com", input_type="VALUE")
