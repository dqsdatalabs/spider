...
class MySpider(Spider):
    name = 'century21_martinot_chalons_com'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source = "Century21_Martinot_Chalons_PySpider_france"

    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-martinot-chalons.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-martinot-chalons.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
