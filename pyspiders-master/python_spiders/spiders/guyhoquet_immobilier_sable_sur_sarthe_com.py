...
class MySpider(Spider):
    name = 'guyhoquet_immobilier_sable_sur_sarthe_com'
    execution_type='testing'
    country='france'
    locale='fr'
    # DYNAMIC VALUES
    gh_domain = "https://sable-sur-sarthe.guy-hoquet.com"
    source_name = "Guyhoquet_Immobilier_Sable_Sur_Sarthe_PySpider_france"
    landlord_n = "GUY HOQUET SABLE SUR SARTHE"
    landlord_p = "02.43.95.91.41"
    # --------------
    headers = {
    ...
    def populate_item(self, response):
        ...
        if response.xpath("//div[@id='intro']//i[contains(@class,'ico king_bed')]/following-sibling::div/text()").get():
            ItemClear(response=response, item_loader=item_loader, item_name="room_count", input_value="//div[@id='intro']//i[contains(@class,'ico king_bed')]/following-sibling::div/text()", input_type="F_XPATH", get_num=True, split_list={" ":0})
        elif response.xpath("//div[@id='intro']//i[contains(@class,'ico room')]/following-sibling::div/text()").get():            
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="parking", input_value="//div[contains(@class,'horaires-item')]//div[contains(.,'garage') or contains(.,'parking')]/following-sibling::div/text()", input_type="F_XPATH", tf_item=True)
