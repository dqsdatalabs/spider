...
class WeidnerComSpider(scrapy.Spider):
    name = "britishcolumbia_weidner_com"
    start_urls = ['https://britishcolumbia.weidner.com/searchlisting.aspx']
    allowed_domains = ["britishcolumbia.weidner.com"]
    country = 'canada'
    locale = 'en'
    ...
    def populate_item(self, response):
        ...
        images = ['https://cdngeneral.rentcafe.com/' + i.split('.jpg')[0]+'.jpg' for i in response.css('img::attr(src)').extract() if 'https:' not in i and '.png' not in i]
