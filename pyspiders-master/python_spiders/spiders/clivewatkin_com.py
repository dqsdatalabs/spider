...
class MySpider(Spider):
    name = 'clivewatkin_com'
    execution_type='testing'
    country='united_kingdom'
    locale='en'
    external_source="Clivewatkin_PySpider_united_kingdom"

    def start_requests(self):
        start_urls = [
            {
                "url": [
                    "https://www.clivewatkin.com/search.ljson?channel=lettings&fragment=tag-flat/most-recent-first/status-all/page-1",
                ],
                "property_type": "apartment"
            },
	        {
                "url": [
                    "https://www.clivewatkin.com/search.ljson?channel=lettings&fragment=tag-house/most-recent-first/status-all/page-1",
                ],
                "property_type": "house"
            },
        ]  # LEVEL 1
    ...
    def parse(self, response):
        ...
        for item in data:
            ...
            item=f"https://www.clivewatkin.com/"+item['url']
