...
class MySpider(Spider):
    ...
    def start_requests(self):
        ...
        p_url = "https://www.beeresidential.co.uk/Search/GetProperties"
        yield Request(
            p_url,
            callback=self.parse,
            body=payload,
    ...
    def parse(self, response):
        ...
        for item in data["result"]["ArticlesMapInformation"]:
            ...
            follow_url = f"https://www.beeresidential.co.uk/Property/Details?Id={item['ArticleID']}"
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="external_source", input_value="Beelettings_Co_PySpider_united_kingdom", input_type="VALUE")
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="furnished", input_value="//li[contains(.,'FURNISHED')]/text() | //div[@class='sectionBody']//text()[.='Furnished']", input_type="F_XPATH", tf_item=True)
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_name", input_value="Bee Residential", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_phone", input_value="01733 552 366", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_email", input_value="lettings@beeresidential.co.uk", input_type="VALUE")
