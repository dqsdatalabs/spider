...
class MySpider(Spider):
    ...
    country='canada'
    locale='en'
    external_source="Alfidlouer_PySpider_canada"
    def start_requests(self):
        start_urls = "https://api.theliftsystem.com/v2/search?locale=en&client_id=1162&auth_token=sswpREkUtyeYjeoahA2i&city_id=3326&geocode=&min_bed=-1&max_bed=100&min_bath=0&max_bath=10&min_rate=0&max_rate=6200&min_sqft=0&max_sqft=10000&only_available_suites=false&show_custom_fields=true&show_promotions=true&region=&keyword=false&property_types=apartments%2C+houses&ownership_types=&exclude_ownership_types=&custom_field_key=&custom_field_values=&order=min_rate+ASC&limit=66&neighbourhood=&amenities=&promotions=&city_ids=2088%2C1863%2C747%2C3218%2C69%2C2791%2C3326&pet_friendly=&offset=0&count=false"
    ...
    def populate_item(self, response):
        ...
        balcony = "".join(response.xpath("//div[@class='amenity-holder']//text()[contains(.,'balcony') or contains(.,'Balcony') or contains(.,'Balconies')]").extract())
        if balcony:
        ...
        item_loader.add_value("landlord_name", "ALFID")
        item_loader.add_value("landlord_phone", "514-465-8685")
