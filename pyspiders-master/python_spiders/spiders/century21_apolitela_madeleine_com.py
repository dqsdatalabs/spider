...
class MySpider(Spider):
    name = 'century21_apolitela_madeleine_com'
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-apolite-la-madeleine.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-apolite-la-madeleine.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21_Apolite_La_Madeleine_PySpider_france")
        ...
        item_loader.add_value("landlord_phone", "03 20 06 13 13 ")
        item_loader.add_value("landlord_name", "CENTURY 21 Apolite")
