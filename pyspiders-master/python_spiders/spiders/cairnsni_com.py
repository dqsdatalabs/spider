...
class MySpider(Spider):
    ...
    def start_requests(self):
        ...
        start_urls = [
            {
                "url" : [
                    "https://www.cairnsni.com/search?sta=toLet&st=rent&pt=residential&stygrp=3",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "https://www.cairnsni.com/search?sta=toLet&st=rent&pt=residential&stygrp=2&stygrp=8&stygrp=9&stygrp=6",
                ],
                "property_type" : "house"
            },
        ]
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Cairnsni_PySpider_united_kingdom")
        ...
        city = response.xpath("//span[contains(@class,'address-other')]//span[contains(@class,'locality')]//text()").get()
        if city:
            item_loader.add_value("city", city)
        
        zipcode = response.xpath("//span[contains(@class,'address-other')]//span[contains(@class,'postcode')]//text()").get()
        if zipcode:
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_name", input_value="CAIRNS & CO", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_phone", input_value="028 9073 8888", input_type="VALUE")
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_email", input_value="hi@cairnsni.com", input_type="VALUE")
