...
class Koeln_homecompanyDeSpider(scrapy.Spider):
    name = 'koeln_homecompany_de'
    allowed_domains = ['koeln.homecompany.de']
    start_urls = ['https://koeln.homecompany.de/en/search']  # https not http
    country = 'germany'
    locale = 'de'
    ...
    def parse(self, response, **kwargs):
        ...
        for rental in rentals:
            yield Request(url='https://koeln.homecompany.de/'+rental,
                          callback=self.populate_item)
        if response.css('.nextpage'):
            next_page = response.css('.nextpage::attr(href)').extract_first()
            yield Request(url='https://koeln.homecompany.de/'+next_page,
                          callback=self.parse)
    ...
    def populate_item(self, response):
        ...
        images = ['https://koeln.homecompany.de/'+i for i in images]
        ...
        landlord_name = "koeln homecompany"
        landlord_phone = "+ 49 (0) 234 - 19445"
        landlord_email = "koeln@homecompany.de"
