...
class MySpider(Spider):
    name = 'century21_montchat_lyon_com'
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-montchat-lyon.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-montchat-lyon.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
   ...
   # 1. FOLLOWING
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21_Montchat_Lyon_PySpider_france")
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 Montchat")
