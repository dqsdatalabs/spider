...
class MySpider(Spider):
    name = 'immobilier_agen_nestenn_com'
    execution_type='testing'
    country='france'
    locale='fr'
    # DYNAMIC DATA
    b_url = "https://immobilier-agen.nestenn.com"
    external_source = "Immobilier_Agen_Nestenn_PySpider_france"
    landlord_n = "Agent immobilier Agen"
    landlord_p = "05 53 86 38 27"
    # -------------
    ...
    def populate_item(self, response):
        ...
        if response.xpath("//h2[@id='titre']/text()[contains(.,'Appartement') or contains(.,'appartement')]").get(): item_loader.add_value("property_type", "apartment")
        if response.xpath("//h2[@id='titre']/text()[contains(.,'Studio') or contains(.,'studio')]").get(): item_loader.add_value("property_type", "studio")
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="zipcode", input_value="//div[@id='fil_ariane']/div[contains(.,'Location ')]/a/text()", input_type="F_XPATH", split_list={" ":3}, replace_list={"(":"", ")":""})
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="room_count", input_value="//div[@id='groupeIcon']/div/div[contains(.,'piece')]/text()", input_type="F_XPATH", get_num=True)
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="landlord_email", input_value="agen@nestenn.com", input_type="VALUE")
