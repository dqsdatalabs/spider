...
class MySpider(Spider):
    name = 'century21sorimparis18_com'
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-sorim-paris-18.com/annonces/location-appartement/v-paris/", "property_type": "apartment"},
	        {"url": "https://www.century21-sorim-paris-18.com/annonces/location-maison/v-paris/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21sorimparis18_PySpider_"+ self.country + "_" + self.locale)
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 Sorim")
        item_loader.add_value("landlord_phone", "01 42 59 09 09")
        item_loader.add_value("landlord_email", "ag442@century21france.fr")
