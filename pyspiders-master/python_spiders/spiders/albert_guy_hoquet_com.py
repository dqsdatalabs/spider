...
class MySpider(Spider):
    name = 'albert_guy_hoquet_com'
    execution_type='testing'
    country='france'
    locale='fr'
    # DYNAMIC VALUES
    gh_domain = "https://albert.guy-hoquet.com"
    source_name = "Albert_Guy_Hoquet_PySpider_france"
    landlord_n = "GUY HOQUET ALBERT"
    landlord_p = "03 22 64 10 65"
    # --------------
    headers = {
    ...
    def populate_item(self, response):
        ...
        ItemClear(response=response, item_loader=item_loader, item_name="zipcode", input_value="//script[contains(.,'postalCode')]/text()", input_type="F_XPATH", split_list={'Code" : "':1, '"':0})
        ItemClear(response=response, item_loader=item_loader, item_name="city", input_value="//script[contains(.,'addressLocality')]/text()", input_type="F_XPATH", split_list={'sLocality" : "':1, '"':0})
