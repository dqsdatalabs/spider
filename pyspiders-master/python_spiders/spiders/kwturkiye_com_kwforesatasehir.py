...
class MySpider(Spider):
    name = 'kwturkiye_com_kwforesatasehir'
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Kwturkiyeforesatasehir_PySpider_"+ self.country + "_" + self.locale)
