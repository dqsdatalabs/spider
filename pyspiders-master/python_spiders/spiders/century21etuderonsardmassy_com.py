...
class MySpider(Spider):
    name = 'century21etuderonsardmassy_com'
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-etude-ronsard-massy.com/annonces/location/?types_biens=appartement&xhr=true", "property_type": "apartment"},
	        {"url": "https://www.century21-etude-ronsard-massy.com/annonces/location/?types_biens=maison&xhr=true", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21etuderonsardmassy_PySpider_"+ self.country + "_" + self.locale)
        ...
        item_loader.add_value("landlord_phone", "01 64 47 15 15")
        item_loader.add_value("landlord_name", "CENTURY 21 Etude Ronsard")
