...
class Bremen_homecompany_deSpider(Spider):
    name = 'bremen_homecompany_de'
    country='germany'
    locale='de' 
    external_source = "{}_PySpider_{}_{}".format(name.capitalize(), country, locale)
    execution_type='testing'
    allowed_domains = ["www.bremen.homecompany.de"]
    start_urls = ["https://bremen.homecompany.de/en/suchergebnis/noreset/1"]
    position = 1
    ...
    def populate_item(self, response):
        ...
        landlord_phone = "+ 49 (0) 421 - 19445"
        landlord_email = "bremen@homecompany.de"
