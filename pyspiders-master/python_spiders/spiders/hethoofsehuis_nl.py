...
class MySpider(Spider):
    name = 'hethoofsehuis_nl'
    execution_type = 'testing'
    country = 'netherlands'
    locale = 'nl'
    external_source = "Hethoofsehuis_PySpider_netherlands"
    ...
    formdata = {
        "action": "all_houses",
        "api": "0197446bddf8f35c6f586e4e881b8d40",
    ...
    def parse(self, response):
        ...
        if data:
            for item in data:
                f_url = f"https://www.hethoofsehuis.nl/woning?{item['city'].replace(' ','-')}/{item['street'].replace(' ','-')}/{item['house_id']}"
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("landlord_name", "Het Hoofse Huis")
        item_loader.add_value("landlord_phone", "+31 6 1993 4085")
        item_loader.add_value("landlord_email", "info@hethoofsehuis.nl")
