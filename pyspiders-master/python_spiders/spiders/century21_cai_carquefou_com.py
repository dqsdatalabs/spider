...
class MySpider(Spider):
    name = 'century21_cai_carquefou_com'
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-cai-carquefou.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-cai-carquefou.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21_Cai_Carquefou_PySpider_france")
        ...
        item_loader.add_value("landlord_phone", "02 51 13 36 50")
