...
class MySpider(Spider):
    ...
    def start_requests(self):
        ...
        start_urls = [
            {
                "url" : [
                    "https://www.propertypeopleni.com/search?sta=toLet&st=rent&pt=residential&stygrp=3",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "https://www.propertypeopleni.com/search?sta=toLet&st=rent&pt=residential&stygrp=2&stygrp=8&stygrp=9&stygrp=6",
                ],
                "property_type" : "house"
            },
            {
                "url" : [
                    "https://www.propertypeopleni.com/search?sta=toLet&st=rent&pt=residential&stygrp=7",
                ],
                "property_type" : "room"
            },
        ]
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Propertypeopleni_PySpider_united_kingdom")          
        ...
        zipcode = " ".join(response.xpath("//h1[@class='Address ']/span/span[@class='Address-addressPostcode']/span/text()").getall())
        if zipcode:
            item_loader.add_value("zipcode", zipcode.strip())
        city = response.xpath("//h1[@class='Address ']/span/span[@class='Address-addressTown']//text()").get()
        if city:
        ...
        energy_label = response.xpath("//tr[th[.='EPC Rating']]/td//text()[contains(.,'/')]").get()
        if energy_label:
        ...
        item_loader.add_value("landlord_name", "Property People")
        item_loader.add_value("landlord_phone", "028 9074 7300")
        item_loader.add_value("landlord_email", "advice@propertypeopleni.com")
