...
class HamburgHomecompanySpider(Spider):
    name = 'hamburg_homecompany_de'
    country='germany'
    locale='de' 
    external_source = "{}_PySpider_{}_{}".format(name.capitalize(), country, locale)
    execution_type='testing'
    allowed_domains = ["www.hamburg.homecompany.de"]
    start_urls = ["https://hamburg.homecompany.de/en/search"]
    ...
    def populate_item(self, response):
        ...
        landlord_email = "hamburg@homecompany.de"
