...
class MySpider(Spider):
    name = 'burbridge_ducann_com'
    execution_type='testing'
    country='united_kingdom'
    locale='en' 
    thousand_separator = ','
    scale_separator = '.'   
    external_source="Burbridge_Ducann_PySpider_united_kingdom"
    ...
    def start_requests(self):
        ...
        start_urls = [
            {
                "url" : [
                    "http://burbridge-ducann.com/search/107998/",
                ],
                "property_type" : "apartment",
            },
            {
                "url" : [
                    "http://burbridge-ducann.com/search/107999/",
                ],
                "property_type" : "house"
            },
        ]
    ...
    def populate_item(self, response):
        ...
        parking = response.xpath("//li[contains(.,'Parking')]/text() | //h2[span[.='Description']]/following-sibling::div[1]/text()[contains(.,'parking')]").get()
        if parking:
        ...
        item_loader.add_value("landlord_name", "BURBRIDGE DUCANN ESTATE AGENTS")
        item_loader.add_value("landlord_phone", "028 90 653 444")
        item_loader.add_value("landlord_email", "info@burbridge-ducann.com")
