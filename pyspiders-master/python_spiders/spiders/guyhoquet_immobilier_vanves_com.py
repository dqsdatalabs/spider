...
class MySpider(Spider):
    name = 'guyhoquet_immobilier_vanves_com'
    ...
    headers = {
        ...
        'referer': "https://vanves.guy-hoquet.com/biens/result",
    ...
    def start_requests(self):
        start_urls = [
            ...
            {"url": "https://vanves.guy-hoquet.com/biens/result?1&templates%5B%5D=properties&p=1&t=&filters%5B10%5D%5B%5D=2&filters%5B30%5D%5B0%5D%5B%5D=appartement&with_markers=false&_=1608888458167", "property_type": "apartment"},
	        {"url": "https://vanves.guy-hoquet.com/biens/result?1&templates%5B%5D=properties&p=1&t=&filters%5B10%5D%5B%5D=2&filters%5B30%5D%5B0%5D%5B%5D=maison&with_markers=false&_=1608888458169", "property_type": "house"},
        ] 
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Guyhoquet_Immobilier_Vanves_PySpider_france")
        ...
        item_loader.add_value("landlord_name", "GUY HOQUET VANVES")
        item_loader.add_value("landlord_phone", "01.55.95.81.81")
        item_loader.add_value("landlord_email", "vanves@guyhoquet.com")
