...
class patricklowneySpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for ad in data:
            if ad['saleLease'] == "Lease" and ad["status"] == "Available":
                ...
                external_link = "https://patricklowney.com/listing/" + ad['address'].replace(",","").lower().replace(" ","-")+'-'+external_id+"?id="+str(ad['listingId'])
    ...
    def parse_page(self, response):
        ...
        item.add_value("landlord_name"          ,'Patrick Lowney')
        item.add_value("landlord_phone"         ,'647-208-0661')
        item.add_value("landlord_email"         ,'patrick@patricklowney.com')
