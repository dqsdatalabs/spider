...
class MySpider(Spider):
    name = 'century21_la_big_bagnols_com'
    execution_type='testing'
    country='france'
    locale='fr'
    external_source='Century21_La_Big_Bagnols_PySpider_france'
    custom_settings = {
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-la-big-bagnols.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-la-big-bagnols.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 La Big")
        item_loader.add_value("landlord_phone", "04 66 89 07 55")
        item_loader.add_value("landlord_email", "labig@century21.fr")
