...
class MySpider(Spider):
    name = 'century21_gp_dammartin_com'
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-gp-dammartin.com/annonces/location-appartement/", "property_type": "apartment"},
	        {"url": "https://www.century21-gp-dammartin.com/annonces/location-maison/", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21_Gp_Dammartin_PySpider_france")
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 GP Immobilier")
