...
class MySpider(Spider):
    name = 'guyhoquet_immobilier_savignysurorge_com'
    execution_type='testing'
    country='france'
    locale='fr'
    gh_domain = "https://savigny-sur-orge.guy-hoquet.com"
    headers = {
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Guyhoquet_Immobilier_Savignysurorge_PySpider_france")
        ...
        parking="".join(response.xpath("//div[@class='biens-list']//div/i[contains(@class,'parking')]/parent::div//text() | //div[contains(@class,'horaires-ttl') and contains(.,'Station')]/following-sibling::div/text()[contains(.,'Garage')]").getall())
        if parking:
            item_loader.add_value("parking", True)
        
        import dateparser
        available_date = response.xpath("//span[contains(@class,'description')]//text()[contains(.,'Disponible le')]").get()
        if available_date:
        ...
        item_loader.add_value("landlord_email", "savignysurorge@guyhoquet.com")
