...
class MySpider(Spider):
    ...
    def start_requests(self):
        start_urls = [
            {"url": "https://www.century21-ido-corbas.com/annonces/location/?types_biens=appartement&xhr=true", "property_type": "apartment"},
	        {"url": "https://www.century21-ido-corbas.com/annonces/location/?types_biens=maison&xhr=true", "property_type": "house"},
        ]  # LEVEL 1
    ...
    def populate_item(self, response):
        ...
        item_loader.add_value("external_source", "Century21idocorbas_PySpider_"+ self.country + "_" + self.locale)
        ...
        item_loader.add_value("landlord_name", "CENTURY 21 Immobilière de l'Ozon")
        item_loader.add_value("landlord_phone", "04 72 21 90 21")
        item_loader.add_value("landlord_email", "immo.ozon@century21france.fr")
